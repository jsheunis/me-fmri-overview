...
nav_item1 = dbc.NavItem(dbc.NavLink("Studies", href="/pages/page1", external_link=True))
nav_item2 = dbc.NavItem(dbc.NavLink("Study parameters", href="/pages/page2", external_link=True))
nav_item3 = dbc.NavItem(dbc.NavLink("Sequence parameters", href="/pages/page3", external_link=True))
        ...
        dbc.Container(
            [
                html.A(
                    ...
                    dbc.Row(
                        [
                            dbc.Col(html.Img(id='logo', src='assets/tedana_logo_square.png', height="32px", className="avatar")),
                            dbc.Col(dbc.NavbarBrand("Multi-echo fMRI overview", className="ml-2")),
                        ],
                        align="center",
                        no_gutters=True,
                    ),
...
def display_page(pathname):
    if pathname == '/':
        logo_url = 'assets/tedana_logo_square.png'
